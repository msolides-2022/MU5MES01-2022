...
- If you get `CondaValueError: prefix already exists: /Users/maurini/opt/anaconda3/envs/fenicsx-0.5.1` try with
    ...
    ```
- If you have issues with pyvista, try setting `pyvista.set_jupyter_backend("none")`. If this does not work, just do not use pyvista: comment the related lines of code, save to xdmf format and visualize results in paraview.
